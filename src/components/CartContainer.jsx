    ...
    >
      <div className="w-full flex items-center justify-between p-4 cursor-pointer">
        <motion.div whileTap={{ scale: 0.75 }} onClick={showCart}>
          <MdClose className="text-textColor text-3xl" />
        </motion.div>
      ...
      {cartItems && cartItems.length > 0 ? (
        <div className="w-full h-full bg-white rounded-t-[2rem] flex flex-col">
          ...
          {/* cart total section */}
          <div className="w-full flex-1 shadow-lg bg-slate-100 rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
            <div className="w-full flex items-center justify-between">
              <p className="text-black text-lg">Sub Total</p>
              <p className="text-black text-lg">$ {tot.toFixed(2)}</p>
            </div>
            <div className="w-full flex items-center justify-between">
